    ...
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Análisis de actividad del sistema para los últimos {period} días
              </CardDescription>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Número de registros de auditoría por día
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-80">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Top 10 acciones por número de registros
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Recursos Más Accedidos</CardTitle>
            <CardDescription>
              Distribución de accesos por tipo de recurso
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Top 10 usuarios por número de acciones realizadas
          </CardDescription>
        </CardHeader>
        <CardContent>
