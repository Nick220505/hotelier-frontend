...
const hotelConfigSchema = z.object({
  propertyName: z.string().min(1, "El nombre del hotel es requerido"),
  propertyEmail: z.string().email("Email inválido"),
  propertyPhone: z.string().min(1, "El teléfono es requerido"),
  propertyAddress: z.string().min(1, "La dirección es requerida"),
  checkInTime: z.string().min(1, "La hora de check-in es requerida"),
  checkOutTime: z.string().min(1, "La hora de check-out es requerida"),
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="propertyName">Nombre del Hotel</Label>
              <Input
                id="propertyName"
            ...
            <div className="space-y-2">
              <Label htmlFor="propertyPhone">Teléfono</Label>
              <Input
                id="propertyPhone"
