...
export default function StyleGuidePage() {
  const colorPalettes = [
    {
      name: 'Brand Primary',
      description: 'Professional hospitality blue for primary actions and branding',
  ...
  const TypographyExample = () => (
    <div className="space-y-4">
      <h1 className="text-4xl font-bold text-foreground">Heading 1 - Welcome to Hotelier</h1>
      <h2 className="text-3xl font-semibold text-foreground">Heading 2 - Dashboard Overview</h2>
      <h3 className="text-2xl font-semibold text-foreground">Heading 3 - Room Management</h3>
      <h4 className="text-xl font-medium text-foreground">Heading 4 - Recent Bookings</h4>
      <p className="text-lg text-foreground">Large text - Important information for hotel staff</p>
      <p className="text-base text-foreground">Body text - Regular content and descriptions</p>
      <p className="text-sm text-muted-foreground">Small text - Supporting information and labels</p>
  ...
  const BadgeShowcase = () => (
    <div className="flex flex-wrap gap-2">
      ...
      <Badge className="bg-destructive text-destructive-foreground">Out of Order</Badge>
  ...
  return (
    <div className="container mx-auto p-6 space-y-12">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold text-foreground">Hotelier Design System</h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          A comprehensive design system built for the hospitality industry, featuring professional 
          colors, semantic status indicators, and accessible components.
        </p>
      </div>
      ...
      <section className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Consistent text sizing for hierarchy and readability</CardDescription>
          </CardHeader>
          <CardContent>
            <TypographyExample />
          </CardContent>
      ...
      <section className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Visual indicators for states and categories</CardDescription>
          </CardHeader>
          <CardContent>
            <BadgeShowcase />
          </CardContent>
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-semibold text-foreground">Hotel Components</h2>
        <Card>
          <CardHeader>
            <CardTitle>Room Status Components</CardTitle>
            <CardDescription>Specialized components for hotel room management</CardDescription>
          </CardHeader>
          <CardContent>
            <RoomStatusDemo />
          </CardContent>
      ...
      {/* Spacing & Layout */}
      <section className="space-y-6">
        <h2 className="text-3xl font-semibold text-foreground">Spacing & Layout</h2>
        <Card>
          <CardHeader>
            <CardTitle>Spacing Scale</CardTitle>
            <CardDescription>8px grid system for consistent layouts</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {Object.entries(tokens.spacing).slice(0, 8).map(([name, value]) => (
      ...
      {/* Usage Guidelines */}
      <section className="space-y-6">
        <h2 className="text-3xl font-semibold text-foreground">Usage Guidelines</h2>
      ...
      {/* Development Notes */}
      <section className="space-y-6">
        <h2 className="text-3xl font-semibold text-foreground">Development Notes</h2>
        <Card>
          <CardHeader>
            <CardTitle>Implementation</CardTitle>
            <CardDescription>How to use this design system in your code</CardDescription>
          </CardHeader>
...
.room-available {
  background-color: hsl(var(--room-available));
            ...
            <div>
              <h4 className="font-medium text-foreground mb-2">Utility Classes</h4>
              <pre className="bg-muted p-4 rounded text-sm overflow-x-auto">
...
<div className="card-hover">Hoverable Card</div>`}</code>
            ...
            <div>
              <h4 className="font-medium text-foreground mb-2">TypeScript Utilities</h4>
              <pre className="bg-muted p-4 rounded text-sm overflow-x-auto">
