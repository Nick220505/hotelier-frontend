...
export function RoomServiceDialog({
  ...
  const handleSubmit = async () => {
    ...
    if (orderItems.length === 0) {
      toast.error("Por favor agrega al menos un item al pedido");
      return;
    }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Nuevo Pedido Room Service</DialogTitle>
          <DialogDescription>
            Crear un order para entregar en habitación
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="waiter">Mesero Asignado</Label>
              ...
              <div className="flex gap-2">
                <Select value={selectedItem} onValueChange={setSelectedItem}>
                  <SelectTrigger className="flex-1">
                    <SelectValue placeholder="Seleccionar plato o bebida" />
                  </SelectTrigger>
                  <SelectContent>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="notes"
              placeholder="Alergias, restricciones dietéticas o instrucciones especiales..."
              rows={3}
              value={notes}
