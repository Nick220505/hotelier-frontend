    ...
    <Card>
      <CardHeader>
        <div className="flex justify-between items-center">
          <div>
            <CardTitle>Análisis de Segmentos de Clientes</CardTitle>
            <CardDescription>
              Comportamiento y valor por segmento
            </CardDescription>
          </div>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Ingreso Promedio</TableHead>
              <TableHead>Estancia Promedio</TableHead>
          ...
          <TableBody>
            {customerReports.map((report, index) => (
              <TableRow key={index}>
                ...
                <TableCell>{report.averageStay} días</TableCell>
