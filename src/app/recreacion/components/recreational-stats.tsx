    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-medium">Estadísticas y Análisis</h3>
          <Select disabled>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Análisis del rendimiento de las instalaciones recreativas
          </p>
        </div>
      ...
      <Tabs defaultValue="facilities" className="space-y-4">
        <TabsList>
          <TabsTrigger value="facilities">Por Instalación</TabsTrigger>
        ...
        <TabsContent value="facilities" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Uso por Instalación</CardTitle>
              <CardDescription>
                Estadísticas detalladas de cada instalación recreativa
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
        ...
        <TabsContent value="performance" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Ranking de Instalaciones</CardTitle>
              <CardDescription>
                Ordenadas por tasa de utilización
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
