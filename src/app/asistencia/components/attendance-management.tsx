      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Gestión y seguimiento de la asistencia del personal
          </p>
        </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-muted/50">
                    ...
                    <th className="p-4 text-left font-medium">Salida</th>
                    <th className="p-4 text-left font-medium">Total Horas</th>
