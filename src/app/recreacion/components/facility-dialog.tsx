...
const facilityTypes: Array<{ value: FacilityType; label: string }> = [
  ...
  { value: "TENNIS_COURT", label: "Cancha de Tenis" },
  { value: "SPA", label: "Spa" },
  { value: "SAUNA", label: "Sauna" },
  { value: "JACUZZI", label: "Jacuzzi" },
  { value: "GAME_ROOM", label: "Sala de Juegos" },
  { value: "YOGA_STUDIO", label: "Estudio de Yoga" },
  { value: "KIDS_PLAY_AREA", label: "Zona Infantil" },
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Piscina Olímpica" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Mín. Horas Reserva *</FormLabel>
                    <FormControl>
                      <Input type="number" min="1" {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Máx. Horas Reserva *</FormLabel>
                    <FormControl>
                      <Input type="number" min="1" {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Horas Anticipación *</FormLabel>
                    <FormControl>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Permitir reservas para esta instalación
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
