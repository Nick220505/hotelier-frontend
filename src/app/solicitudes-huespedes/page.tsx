  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Gestiona las solicitudes y necesidades de los huéspedes</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Resueltas exitosamente</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Solicitudes canceladas</p>
          </CardContent>
        </Card>
      </div>
